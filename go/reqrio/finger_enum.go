...
const (
	TLS_1_0 Version = 0x301
	TLS_1_1         = 0x302
	TLS_1_2         = 0x303
	TLS_1_3         = 0x304
)

type SupportGroup int

const (
	X25519         SupportGroup = 0x1d
	X448                        = 0x1e
...
const (
	PSK_DHE_KE PskMode = 0x1
)

type Algorithm int

const (
	RSA_PKCS1_SHA1         Algorithm = 0x0201
...
type EcPointFormat int

const (
	UNCOMPRESSED    EcPointFormat = 0
	ANSI_X962_PRIME               = 1
	ANSI_X962_CHAR2               = 2
)
